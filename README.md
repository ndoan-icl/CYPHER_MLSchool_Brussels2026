...
2. The [MLP-based Lorenz system notebook](02_MLP_Lorenz.ipynb) where a feedforward neural network is developed to learn the dynamics of the Lorenz system.
3. The [RNN-based Lorenz system notebook](03_LSTM_Lorenz.ipynb) where a long short-term neural network is developed to learn the dynamics of the Lorenz system.
4. The [ESN-based Lorenz system notebook](04_ESN_Lorenz.ipynb) where an echo state network is developed to learn the dynamics of the Lorenz system. The original version can be found [here](https://github.com/MagriLab/Tutorials).
